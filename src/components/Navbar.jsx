...
const Navbar = () => {
  ...
  return (
    <div className='text-white flex justify-between items-center h-24 mx-auto px-4 max-w-[1240px]'>
         ...
         <div className={nav?'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] duration-200 ease-linear md:hidden':'fixed left-[-100%] top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] duration-500 ease-in-out'}>
